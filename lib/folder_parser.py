...
Example: 100-Chartridge-Lane_CH-0501_MF_JD
  - Address: 100 Chartridge Lane
  - Owner Initials: CH
  - Reference: 0501
  - Surveyor 1: MF (Mark)
  - Surveyor 2: JD (Jon)
...
def parse_folder_name(folder_name: str) -> Optional[SurveyFolderInfo]:
    ...
    Handles formats:
    - 100-Chartridge-Lane_CH-0501_MF_JD
    - Blazing-Saddles-Chartridge-Lane-100_CH-0501_MF_JD
    - _100-Chartridge-Lane_CH-0501_MF_JD (processed, starts with underscore)
    ...
    # Validate reference number is 4 digits
    if not (reference_number.isdigit() and len(reference_number) == 4):
        return None
